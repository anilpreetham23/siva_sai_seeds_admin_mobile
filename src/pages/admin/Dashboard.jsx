...
import ManagerMobileDashboard from '../../components/mobile/ManagerMobileDashboard';
...
export default function AdminDashboard() {
  ...
  return (
    <div className="animate-fade-in">
      {/* Mobile Dashboard View (UI/UX design) */}
      <div className="md:hidden">
        <ManagerMobileDashboard data={data} user={user} />
      </div>
